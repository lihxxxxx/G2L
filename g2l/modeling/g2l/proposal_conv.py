...
def build_proposal_conv(cfg, mask2d):
    input_size = cfg.MODEL.G2L.FEATPOOL.HIDDEN_SIZE
    hidden_size = cfg.MODEL.G2L.PREDICTOR.HIDDEN_SIZE
    kernel_size = cfg.MODEL.G2L.PREDICTOR.KERNEL_SIZE
    num_stack_layers = cfg.MODEL.G2L.PREDICTOR.NUM_STACK_LAYERS
    output_size = cfg.MODEL.G2L.JOINT_SPACE_SIZE
